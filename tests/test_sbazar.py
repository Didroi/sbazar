...
def test_changing_region(open_main_page, prague_main_page):
    open_main_page.open()
    open_main_page.changing_region()
    assert prague_main_page.is_text_present()
    assert prague_main_page.is_localized_text_present()
...
def test_back_to_home_page_by_logo(open_main_page, prague_main_page):
    prague_main_page.open()
